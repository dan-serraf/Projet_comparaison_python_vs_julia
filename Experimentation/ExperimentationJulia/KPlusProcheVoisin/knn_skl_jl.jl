...
nn1 = "../../../Image/ImageJulia/KPlusProcheVoisin/timeknn_skl_julia.png"
nn2 = "../../../Image/ImageJulia/KPlusProcheVoisin/accknn_skl_julia.png"
plt.scatter(nb_iter,temps_time,title="Temps exécution knn k=5 julia sklearn",xlabel="Nombre itération validation croisée",ylabel="Temps d'exécution en seconde")
...
f = open("../../../Image/ImageJulia/KPlusProcheVoisin/knn_skl_julia.txt","w+")
